// https://github.com/ttseng/SoftwareServo/tree/master
class SoftwareServo
{
  private:
    uint8_t pin;
...
// End https://github.com/ttseng/SoftwareServo/tree/master

// #include <SoftwareServo.h>
SoftwareServo servoH;
SoftwareServo servoV;

// Pin Assignments
#define HOUT 1 // ATTiny85 Pin 6
#define VOUT 0 // ATTiny85 Pin 5
#define HIN A3 // ATTiny85 Pin 2
#define VIN A2 // ATTiny85 Pin 3
...
void loop() { 
  // Steering/Lateral
  angleH = map(analogRead(HIN), 0, 1023, 75, 105);
  servoH.write(angleH);
  
  // Pitch/Vertical 
  angleV = map(analogRead(VIN), 0, 1023, 0, 180);
  servoV.write(angleV);
